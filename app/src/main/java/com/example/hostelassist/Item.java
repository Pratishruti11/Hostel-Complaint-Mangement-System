...
public class Item {
    ...
    public static ArrayList<Item> makeMenu(int index) {
        ...
        sundayMenu.add(new Item(0,"B\nR\nE\nA\nK\nF\nA\nS\nT", "7:30 - 9:30 am", "" + "Tea," + "Fried Rice," + "Tomato Chutney," + "Omelette.", null));
