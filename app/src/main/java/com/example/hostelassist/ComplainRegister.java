...
public class ComplainRegister extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkIfNull()){
                    ...
                    newComplain=new ComplainItemClass(user.getEmail(),requesterName,room,hostel,type, status,title,desc,isChecked, receivers);
    ...
    private void initComplain(){
        ...
        roomNo=findViewById(R.id.complain_room_no);
    ...
    private Boolean checkIfNull(){
        ...
        if (room.equals("") || TextUtils.isEmpty(room) || room.length() == 0) {
            Toast.makeText(getApplicationContext(), "Enter your Room Number", Toast.LENGTH_SHORT).show();
            return false ;
