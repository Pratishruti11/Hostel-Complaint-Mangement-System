...
public class ComplainItemClass implements Parcelable {
    ...
    ComplainItemClass(String complainEmail,String complainUsername,String complainRoomNo,String complainHostel,String complainType,long complainTime
        ...
        this.complainRoomNo=complainRoomNo;
    ...
    ComplainItemClass(String complainEmail,String complainUsername,String complainRoomNo,String complainHostel,String complainType
            ,int status,String complainTitle,String complainDetails,boolean complainIsPrivate,String complainReceivers){
    ...
    public String getComplainRoomNo() {
        return complainRoomNo;
    }
    ...
    public void setComplainRoomNo(String complainRoomNo) {
        this.complainRoomNo = complainRoomNo;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(complainRoomNo);
